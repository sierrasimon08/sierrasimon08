...
* 🧮 Métodos numéricos
* 📉 Regresión y análisis de relaciones entre variables
* 🎯 Muestreo y diseño de estudios
* 💻 Programación aplicada a la estadística
...
📈 Análisis de Regresión — construcción, interpretación y evaluación de modelos.

📊 Análisis Multivariado — exploración de múltiples variables y sus relaciones.

🎯 Muestreo — diseño y selección de muestras para obtener información de poblaciones.

🧮 Métodos Numéricos — aproximación y solución computacional de problemas matemáticos.

🐍 Python para análisis de datos — manejo de datos, programación y aplicación de métodos estadísticos.
...
Aquí iré reuniendo proyectos, trabajos académicos y experimentos en los que pueda aplicar lo que voy aprendiendo sobre estadística, programación y análisis de datos.
...
A medida que avance en mi carrera, espero convertir este espacio en una colección de proyectos que muestre no solo las herramientas que sé utilizar, sino también mi forma de pensar como estadístico.
